...
docker run --name remrem-publish -p 8080:8080 -v ./publish-service/src/main/resources/application.properties:/usr/local/tomcat/config/application.properties remrem-generate:<version>
